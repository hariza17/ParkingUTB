package com.utb.ParkingUTB.config;

import com.fasterxml.jackson.databind.ObjectMapper;
import com.fasterxml.jackson.datatype.hibernate4.Hibernate4Module;
import com.utb.ParkingUTB.util.Environment;
...
@Configuration
@ComponentScan("com.utb.ParkingUTB")
@EnableWebMvc
...
public class ApplicationContextConfig extends WebMvcConfigurerAdapter {
    ...
    public DataSource getDataSource() {
        ...
        dataSource.setUrl("jdbc:mysql://localhost:3306/" + Environment.DATABASE + "?zeroDateTimeBehavior=convertToNull");//Local Database
    ...
    public SessionFactory getSessionFactory(DataSource dataSource) {
        ...
        sessionBuilder.scanPackages("com.utb.ParkingUTB.entity");
